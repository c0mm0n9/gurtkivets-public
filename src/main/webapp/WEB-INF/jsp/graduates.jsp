...
<div class = "container" style="margin-left:350px;margin-top:50px;">
  <h2>  Всього випускників: ${fn:length(graduates)} </h2>
  <h2>  Випускники </h2>
  <table>
    <thead>
    <th>ID</th>
    ...
    <c:forEach items="${graduates}" var="graduate">
      <tr>
        ...
        <td>
      <!--   <form action="${pageContext.request.contextPath}/admin/edit-graduates" method="get">
                          <input type="hidden" name="graduateId" value="${graduate.id}"/>
                          <button type="submit">Edit</button>
                        </form> -->

          <form action="${pageContext.request.contextPath}/admin/graduates" method="post">
            <input type="hidden" name="graduatesId" value="${graduate.id}"/>
